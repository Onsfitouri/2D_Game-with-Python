...
#definir une classe qui va s'occuper des annimations
class AnimateSprite(pygame.sprite.Sprite):
    ...
    def __init__(self, sprite_name,size=(200,200)):
        super().__init__()
        self.size = size
        self.image = pygame.image.load(f'assets/PygameAssets-main/PygameAssets-main/{sprite_name}.png')
    ...
    def animate(self, loop =False) :
        #verifier si l'annimation est active 
        if self.animation:
            ...
            if self.current_image >= len(self.images):
                #remettre l'annimation au depart
...
def load_animation_images(sprite_name):
    ...
    path =f"assets/PygameAssets-main/PygameAssets-main/{sprite_name}/{sprite_name}"
